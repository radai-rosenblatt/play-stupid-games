...
public class TestUnderAvro18 {

  @Test
  public void verifyAvro18() throws Exception {
    ...
    Assert.assertEquals("expecting avro 1.8.2, got " + version + "@" + jar, "1.8.2", version);
  }
  ...
  public void showProperSimpleFieldWorks() throws Exception {
    ...
    properGenericSimple.put("f", new GenericData.EnumSymbol(simpleEnumSchema.getField("f").schema(), "B"));
    serialize(properGenericSimple);
  }

  @Test(expected = AvroTypeException.class)
  public void showMalformedSimpleFieldExplodes() throws Exception {
    Schema simpleEnumSchema = SimpleEnumField.SCHEMA$;
  ...
  public void showProperUnionFieldWorks() throws Exception {
    ...
    Schema enumSchema = unionEnumSchema.getField("f").schema().getTypes().get(1);
    Assert.assertEquals("2nd union branch expected to be ENUM", Schema.Type.ENUM, enumSchema.getType());
    GenericData.Record properGenericUnion = new GenericData.Record(unionEnumSchema);
    properGenericUnion.put("f", new GenericData.EnumSymbol(enumSchema, "B"));
